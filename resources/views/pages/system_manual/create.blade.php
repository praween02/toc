                            ...
                            <div class="row jumbotron box8">
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                        ...
                                        <button class="nav-link active" id="nav-infrastructure-tab" data-bs-toggle="tab" data-bs-target="#nav-infrastructure" type="button" role="tab" aria-controls="nav-infrastructure" aria-selected="false">Add New Document</button>
                                        ...
                                        <button class="nav-link active" id="nav-application-tab" data-bs-toggle="tab" data-bs-target="#nav-application" type="button" role="tab" aria-controls="nav-application" aria-selected="true">Add New Document</button>
                                        <!-- <button class="nav-link" id="nav-documents-tab" data-bs-toggle="tab" data-bs-target="#nav-documents" type="button" role="tab" aria-controls="nav-documents" aria-selected="true">Lab Implemention</button>
                                        <button class="nav-link" id="nav-project-solution-tab" data-bs-toggle="tab" data-bs-target="#nav-project-solution" type="button" role="tab" aria-controls="nav-project-solution" aria-selected="false">UAT Procedure</button>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <form method="POST" action="{{ route('system_manual.store') }}" enctype="multipart/form-data" id="form-application">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="typeFilter" class="form-label">{{ __('Select Document') }} </label>
                                                                <select class="form-select" id="typeFilter" name="type">
                                                                    <option value="0" selected>Select Document</option>
                                                                    @if(in_array('vendor', get_roles()))
                                                                    <option value="1">System
                                                                        Manual
                                                                    </option>
                                                                    <option value="2">Lab Implemention
                                                                    </option>
                                                                    <option value="3">UAT
                                                                        Procedure</option>


                                                                    <option value="6">Training Document</option>
                                                                    <option value="7">Document</option>
                                                                    @endif;
                                                                    @if(in_array('institute', get_roles()))
                                                                    <option value="4">UAT Sign
                                                                    </option>
                                                                    <option value="7">Document</option>
                                                                    <!-- <option value="5">Receipt of
                                                                            goods</option> -->
                                                                    @endif;
                                                            ...
                                                            <div class="mb-3 d-none" id="equipment_list">
                                                                <label for="equipment_id_1" class="form-label">{{ __('Products') }} <span class="req">*</span></label>
                                                                <select name="equipment_id" autocomplete="off" class="form-control" id="equipment_id_1">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <form method="POST" action="{{ route('system_manual.store') }}" enctype="multipart/form-data" id="form-uat">
                                                                ...
                                                                <div class="mb-3 d-none" id="sign_date">
                                                                    <label for="date_4" class="form-label">{{ __('Sign Date') }} <span class="req">*</span></label>
                                                                    <input type="date" name="date" autocomplete="off" class="form-control" id="date_4">
                                                                </div>
                                                            ...
                                                            <form method="POST" action="{{ route('system_manual.store') }}" enctype="multipart/form-data" id="form-uat">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select" id="typeFilter" name="type">
                                                                        ...
                                                                        <option value="6">Training Document</option>
                                                                        @endif;
                                                                        @if(in_array('institue', get_roles()))
                                                                        <option value="4">UAT Sign
                                                                        </option>
                                                                        <!-- <option value="5">Receipt of
                                                                            goods</option> -->
    ...
    <script>
        $(document).ready(function() {
            $('#typeFilter').on('change', function() {
                ...
                if (selected === '1') {
                    $('#equipment_list').removeClass('d-none').addClass('d-block');

                } else if (selected === '2') {
                    $('#equipment_list').removeClass('d-block').addClass('d-none');
                } else if (selected === '3') {
                    $('#equipment_list').removeClass('d-block').addClass('d-none');
                } else if (selected === '6') {
                    $('#equipment_list').removeClass('d-block').addClass('d-none');
                    ...
                    $('#equipment_list').removeClass('d-block').addClass('d-none');
                    $('#sign_date').removeClass('d-block').addClass('d-none');
                } else if (selected === '4') {
                    $('#sign_date').removeClass('d-none').addClass('d-block');
                }
