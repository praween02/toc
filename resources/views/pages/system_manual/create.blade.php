                                                    ...
                                                    <div class="card-body">
                                                        <form method="POST" action="{{ route('system_manual.store') }}" enctype="multipart/form-data" id="form-application">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="number" name="no_of_page" autocomplete="off" class="form-control" id="no_of_page_1" placeholder="{{ __('No of Document') }}" required min="1">
                                                    ...
                                                    <div class="card-body">
                                                        <form method="POST" action="{{ route('system_manual.store') }}" enctype="multipart/form-data" id="form-documents">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="number" name="no_of_page" autocomplete="off" class="form-control" id="no_of_page_2" placeholder="{{ __('No of Document') }}" required min="1">
                                                                <div class="text-danger mt-2" id="no_of_page_error" style="display:none;">The number of pages must be greater than 0.</div>
                                                            </div>
