                    ...
                    <form method="POST" action="{{ route('proposals.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('stack_holder') is-invalid @enderror" 
                                ...
                                <option value="Students" {{ old('stack_holder') == 'Students' ? 'selected' : '' }}>Students</option>
                                <option value="Faculties" {{ old('stack_holder') == 'Faculties' ? 'selected' : '' }}>Faculties</option>
                                <option value="Startups" {{ old('stack_holder') == 'Startups' ? 'selected' : '' }}>Startups</option>
                                <option value="MSME" {{ old('stack_holder') == 'MSME' ? 'selected' : '' }}>MSME</option>
                                <option value="Enterprise" {{ old('stack_holder') == 'Enterprise' ? 'selected' : '' }}>Enterprise</option>
                            </select>
                            @error('stack_holder')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('socio_economic_vertical') is-invalid @enderror" 
                                ...
                                <option value="Education" {{ old('socio_economic_vertical') == 'Education' ? 'selected' : '' }}>Education</option>
                                <option value="Agriculture" {{ old('socio_economic_vertical') == 'Agriculture' ? 'selected' : '' }}>Agriculture</option>
                                <option value="Health" {{ old('socio_economic_vertical') == 'Health' ? 'selected' : '' }}>Health</option>
                                <option value="Power" {{ old('socio_economic_vertical') == 'Power' ? 'selected' : '' }}>Power</option>
                                <option value="Ports" {{ old('socio_economic_vertical') == 'Ports' ? 'selected' : '' }}>Ports</option>
                                <option value="Tourism" {{ old('socio_economic_vertical') == 'Tourism' ? 'selected' : '' }}>Tourism</option>
                                <option value="Mining" {{ old('socio_economic_vertical') == 'Mining' ? 'selected' : '' }}>Mining</option>
                                <option value="Logistics" {{ old('socio_economic_vertical') == 'Logistics' ? 'selected' : '' }}>Logistics</option>
                                <option value="e-Governance" {{ old('socio_economic_vertical') == 'e-Governance' ? 'selected' : '' }}>e-Governance</option>
                                <option value="Security" {{ old('socio_economic_vertical') == 'Security' ? 'selected' : '' }}>Security</option>
                                <option value="Urban Management" {{ old('socio_economic_vertical') == 'Urban Management' ? 'selected' : '' }}>Urban Management</option>
                                <option value="Resource Management" {{ old('socio_economic_vertical') == 'Resource Management' ? 'selected' : '' }}>Resource Management</option>
                            </select>
                            ...
                            <select class="form-control @error('institute_id') is-invalid @enderror" 
                                ...
                                @foreach($zoneInstitutes as $institute)
                                    <option value="{{ $institute->id }}" 
                                        {{ (old('institute_id') == $institute->id || $userInstitute->institute_id == $institute->id) ? 'selected' : '' }}>
                                        {{ $institute->institute  }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control select2-with-institute @error('team_members') is-invalid @enderror" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('proposal_brief') is-invalid @enderror" 
                                id="proposal_brief" name="proposal_brief" rows="3" required>{{ old('proposal_brief') }}</textarea>
                        ...
                        <div class="mb-3">
                            <label for="attachment" class="form-label">Proposal Document (PDF, DOC, DOCX - Max 10MB)</label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('days_required') is-invalid @enderror" 
                                        ...
                                        value="{{ old('days_required') }}" required min="1">
                                    @error('days_required')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('expected_output') is-invalid @enderror" 
                                id="expected_output" name="expected_output" rows="3" required>{{ old('expected_output') }}</textarea>
...
<script>
    $(document).ready(function() {
        // Initialize select2
        $('.select2-with-institute').select2({
