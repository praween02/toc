                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title">{{ __('app.add_role') }}</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" id="save-vendor-data-form" action="{{ route('roles.store') }}">
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" autocomplete="off" class="form-control" id="name" placeholder="{{ __('placeholder.role_name') }}" value="{{ old('name') }}" />
