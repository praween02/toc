                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title">{{ __('app.add_equipment') }}</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" id="save-equipment-data-form" action="{{ route('equipments.store') }}">
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                            <label for="equipment" class="form-label">{{ __('Equipment') }} <span class="req">*</span></label>
                                            <input type="text" name="equipment" autocomplete="off" class="form-control" id="equipment" placeholder="{{ __('placeholder.equipment') }}" value="{{ old('equipment') }}" />
