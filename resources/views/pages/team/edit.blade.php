                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title">{{ __('app.update_committee') }}</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" id="save-team-data-form" action="{{ route('teams.update', $team->id) }}">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="committee" autocomplete="off" class="form-control" id="committee" placeholder="{{ __('app.committee') }}" value="{{ $team->team }}" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="experts[]" class="form-control" multiple>
                                                @foreach($experts as $expert)
                                                  <option {{ in_array($expert->user_id, $sel_experts) ? "selected" : "" }} value="{{ $expert->user_id }}">{{ $expert->first_name }}</option>
                                                @endforeach
                                            </select> 
