                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title">{{ __('app.add_payment') }}</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" id="save-payment-data-form" action="{{ route('payments.store') }}">
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="utr_no" autocomplete="off" class="form-control" id="utr_no" placeholder="{{ __('placeholder.utr_no') }}" value="{{ old('utr_no') }}" />
                                         ...
                                         <div class="mb-3">
                                            ...
                                            <input type="date" name="transaction_date" autocomplete="off" class="form-control" id="transaction_date" placeholder="{{ __('placeholder.transaction_date') }}" value="{{ old('transaction_date') }}" />
                                         ...
                                         <div class="mb-3">
                                            ...
                                            <input type="number" name="amount" autocomplete="off" class="form-control" id="amount" placeholder="{{ __('placeholder.amount') }}" value="{{ old('amount') }}" />
