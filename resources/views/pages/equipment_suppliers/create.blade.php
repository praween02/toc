@extends('layouts.app')
@section('title', ' - Add Equipment Supplier')
@section('content')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title">{{ __('app.equipment_supplier') }}</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" id="save-supplier-user-form" action="{{ route('equipment_suppliers.store') }}">
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="company_name" autocomplete="off" class="form-control" id="company_name" placeholder="{{ __('placeholder.company_name') }}" value="{{ old('company_name') }}" />
