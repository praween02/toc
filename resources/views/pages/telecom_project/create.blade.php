                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" id="save-telecom-project-form" action="{{ route('telecom.store') }}">
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="implementing_agency" autocomplete="off" class="form-control" id="implementing_agency" placeholder="{{ __('Implementing Agency') }}" value="{{ old('implementing_agency') }}" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="core_technology" autocomplete="off" class="form-control" id="core_technology" placeholder="{{ __('Core Technology') }}" value="{{ old('core_technology') }}" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="cost" autocomplete="off" class="form-control" id="cost" placeholder="{{ __('Cost') }}" value="{{ old('cost') }}" />
