                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title">{{ __('app.add_institute') }}</h4>
                            </div>
                        </div>
                    </div>     
                    <!-- end page title --> 
                        ...
                        <div class="col-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" id="save-institute-data-form" action="{{ route('institutes.store') }}">
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="institute" autocomplete="off" class="form-control" id="institute" placeholder="{{ __('placeholder.institute') }}" value="{{ old('institute') }}" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="address" autocomplete="off" class="form-control" id="address" placeholder="{{ __('placeholder.address') }}">{{ old('address') }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="contact_person" autocomplete="off" class="form-control" id="contact_person" placeholder="{{ __('placeholder.contact_person') }}" value="{{ old('contact_person') }}" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="contact_number" autocomplete="off" class="form-control" id="contact_number" placeholder="{{ __('placeholder.contact_number') }}" value="{{ old('contact_number') }}" />
                                        ...
                                        <div class="mb-3">
                                            <label for="status" class="form-label">{{ __('labels.status') }} <span class="req">*</span></label>
