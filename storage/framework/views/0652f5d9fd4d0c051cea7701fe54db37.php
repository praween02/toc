                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <form method="POST" action="<?php echo e(route('system_manual.store')); ?>" enctype="multipart/form-data" id="form-uat">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="date_3" class="form-label"><?php echo e(__('Receipt Of Goods Date')); ?> <span class="req">*</span></label>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="document_file_3" class="form-label"><?php echo e(__('Document Of Receipt Of Goods')); ?> <span class="req">*</span></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u457512262/domains/dssolution.in/public_html/dot/resources/views/pages/system_manual/ReceiptOfGoodsCreate.blade.php ENDPATH**/ ?>