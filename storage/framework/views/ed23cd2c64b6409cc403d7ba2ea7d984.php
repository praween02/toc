                               ...
                               <!-- <h6>Lab Status</h6> -->
                                <div class="card-body brder">
                                     <div id="container" class="txt-head">
                                        <a href="<?php echo e(route('expert_user')); ?>" title="Apply For Expert">Apply For Expert</a>
                                     </div>
                                </div>
                            </div>
                        ...
                        <!-- end col-->
                         <div class="col-md-6 col-xl-4">
                            <div class="widget-rounded-circle card">
                               <!-- <h6>Projects</h6> -->
                                <div class="card-body brder">
                                    <div id="container" class="txt-head">
                                        <a href="<?php echo e(route('poc_bsnl')); ?>" title="Apply For BSNL POC">Apply For BSNL POC</a>
                                    </div>
                                </div>
                            </div>
                            <!-- end widget-rounded-circle-->
                         ...
                         <div class="col-md-6 col-xl-4">
                            <div class="widget-rounded-circle card">
                               ...
                               <div class="card-body brder">
                                    <div id="container" class="txt-head">
                                        <a href="<?php echo e(route('six_g_user')); ?>" title="Apply For 6G Application">Apply For 6G Application</a>
                                    </div>
                                  <!-- end row-->
                               </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u457512262/domains/dssolution.in/public_html/dot/resources/views/pages/dashboard/user.blade.php ENDPATH**/ ?>