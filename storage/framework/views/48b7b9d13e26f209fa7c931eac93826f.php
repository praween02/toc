                                   ...
                                   <div class="card-body pdtp15">
                                      <div class="row">
                                        <h5>6G Applications</h5>
                                         ...
                                         <div class="col-6">
                                            <div class="text-end">
                                               <a href="<?php echo e(route('six_g_user.index')); ?>" target="_blank"><h2 class="text-white mt-2"><span data-plugin="counterup"><?php echo e($response['six_g_total']); ?></span></h2></a>
                                               <p class="text-white mb-0 text-truncate ltrsp"><a title="All" href="<?php echo e(route('six_g_user.index')); ?>?tab=all">All - <?php echo e($response['total_6g_application']); ?></a></p>
                                               <p class="text-white mb-0 text-truncate ltrsp"><a title="Submitted" href="<?php echo e(route('six_g_user.index')); ?>?tab=submitted">Submitted - <?php echo e($response['submit_6g_application']); ?></a></p>
                                               <p class="text-white mb-0 text-truncate ltrsp"><a title="Pending" href="<?php echo e(route('six_g_user.index')); ?>?tab=pending">Pending - <?php echo e($response['total_6g_application'] - $response['submit_6g_application']); ?></a></p>
                                            </div>
                                         </div>
                                      </div>
                                ...
                                <div class="widget-rounded-circle card bg-primary shadow-none" style="height:160px">
                                   <div class="card-body pdtp15">
                                      <div class="row">
                                         ...
                                         <div class="col-6">
                                            <div class="text-end">
                                               <a href="<?php echo e(route('expert_user.index')); ?>" target="_blank"><h2 class="text-white mt-2"><span data-plugin="counterup"><?php echo e($response['expert_total']); ?></span></h2></a>
                                            </div>
                                         </div>
                                      </div>
                                      <!-- end row-->
                                   ...
                                   <div class="card-body pdtp15">
                                    <h5>POC BSNL</h5>
                                      <div class="row">
                                         ...
                                         <div class="col-6">
                                            <div class="text-end">
                                               <a href="<?php echo e(route('poc_bsnl.index')); ?>" target="_blank"><h2 class="text-white mt-2"><span data-plugin="counterup"><?php echo e($response['poc_bsnl_total']); ?></span></h2></a>
                                            </div>
                                         </div>
                                      </div>
                                      <!-- end row-->
    ...
    series: [
        {
            ...
            data: [
                {
                    name: 'Delivered',
                    // y: <?php echo $response['eq_stats']->delivered ?>,
                    y: 100,
                    drilldown: 'Delivered'
                },
                {
    ...
    series: [
        {
            ...
            data: [
                {
                    name: 'Received',
                    y: <?php echo (int) $response['ticket_data']->received ?>,
                    drilldown: 'Received'
                },
...
Highcharts.chart('container12', {
    ...
    xAxis: {
        categories: [<?php echo "'" . implode("','", $response['categories_arr']) . "'"  ?>]
    },
    credits: {
        enabled: false
    },
    ...
    series: [{
        name: 'Delivered',
        // data: [<?php echo implode(',', $response['equipment_delivery_date_arr']) ?>]
        data: [25,25,25,25,25]
    }, {
        name: 'Installed',
        // data: [<?php echo implode(',', $response['equipment_installed_arr']) ?>]
        data: [25,25,25,25,25]
    }, {
        name: 'UAT Completed',
        // data: [<?php echo implode(',', $response['equipment_commissioned_arr']) ?>]
        data: [25,25,25,25,25]
    }]
});
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u457512262/domains/dssolution.in/public_html/dot/resources/views/pages/dashboard/super_admin.blade.php ENDPATH**/ ?>