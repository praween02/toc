...
<div class="left-side-menu">
  <div class="h-100" data-simplebar>
    ...
    <div id="sidebar-menu">
      <ul id="side-menu">
        ...
        <li>
          <a href="<?php echo e(route('system_manual.index')); ?>"><i class="fe-list"></i> <span><?php echo e(__("Document")); ?></span></a>
        </li>

        <!-- <li>
          <a href="<?php echo e(route('system_manual.signature-uat')); ?>"><i class="fe-list"></i> <span><?php echo e(__("Institute Document")); ?></span></a>
        </li> -->
  ...
  <!-- Sidebar -left -->
</div><?php /**PATH /home/u457512262/domains/dssolution.in/public_html/dot/resources/views/partials/vendor-left-side-bar.blade.php ENDPATH**/ ?>