<?php $__env->startSection('title', ' - Edit Committee'); ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title"><?php echo e(__('app.update_committee')); ?></h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" id="save-team-data-form" action="<?php echo e(route('teams.update', $team->id)); ?>">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="committee" autocomplete="off" class="form-control" id="committee" placeholder="<?php echo e(__('app.committee')); ?>" value="<?php echo e($team->team); ?>" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="experts[]" class="form-control" multiple>
                                                <?php $__currentLoopData = $experts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  <option <?php echo e(in_array($expert->user_id, $sel_experts) ? "selected" : ""); ?> value="<?php echo e($expert->user_id); ?>"><?php echo e($expert->first_name); ?></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u457512262/domains/dssolution.in/public_html/dot/resources/views/pages/team/edit.blade.php ENDPATH**/ ?>