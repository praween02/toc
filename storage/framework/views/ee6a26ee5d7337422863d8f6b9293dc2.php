                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title"><?php echo e(__('app.update_course')); ?></h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" id="save-role-data-form" action="<?php echo e(route('courses.update', $course->id)); ?>">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="course" autocomplete="off" class="form-control" id="course" placeholder="<?php echo e(__('placeholder.course')); ?>" value="<?php echo e($course->course); ?>" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u457512262/domains/dssolution.in/public_html/dot/resources/views/pages/course/edit.blade.php ENDPATH**/ ?>