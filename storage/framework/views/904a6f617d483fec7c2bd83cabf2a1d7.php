                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title"><small><label style="color:#2f316f"><?php echo e(__('app.vendor')); ?>:</label> <?php echo e($vendor_name); ?></small></h4>
                                <h4 class="page-title"><small><label style="color:#2f316f"><?php echo e(__('app.institute')); ?>:</label> <?php echo e($inst_name); ?></small></h4>
                            </div>
                        </div>
                    </div>     
                    <!-- end page title --> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($equipment->equipment_dispatch_date): ?>
                                                            <div class="box"><strong>Scheduled</strong> [<?php echo e(date('D, j M\'y', strtotime($equipment->equipment_dispatch_date))); ?>]</div> 
                                                            <?php if(empty($equipment->equipment_actual_dispatch_date)): ?>
                                                                <button style="display:none" type="button" class="btn btn-info btn-xs btstrp_model" style="padding:3px 5px;font-size:10px;" onclick="showModal('<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($equipment->pt_id)); ?>', '<?php echo e($equipment->equipment_delivery_date); ?>')">Approve</button>
                                                            <?php else: ?>
                                                                <div class="box"><strong>Actual Dispatch Date:</strong> [<?php echo e(date('D, j M\'y', strtotime($equipment->equipment_actual_dispatch_date))); ?>] </div>
                                                            <?php endif; ?>
                                                        <?php else: ?>
                                                            <span>N/A</span>
                                                        <?php endif; ?>
                                                    ...
                                                    <td>
                                                        <?php if($equipment->dispatch_invoice_file): ?>
                                                            <a target="_blank" download href="<?php echo e(url('storage/uploads/' . $equipment->dispatch_invoice_file)); ?>"><i class="fa fa-pdf"></i> <?php echo e($equipment->dispatch_invoice_file); ?></a>
                                                        <?php else: ?>
                                                            <span>N/A</span>
                                                        <?php endif; ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if(empty($equipment->equipment_delivered_date)): ?>
                                                             <button type="button" class="btn btn-info btn-xs btstrp_model" style="padding:3px 5px;font-size:10px;" onclick="showActionModal('<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($equipment->pt_id)); ?>', 1, '<?php echo e($equipment->equipment_delivery_date); ?>')">Approve</button>
                                                        <?php else: ?>
                                                        <div class="box"><strong>Delivered:</strong> <?php echo e(date('D, j M\'y', strtotime($equipment->equipment_delivered_date))); ?></div>
                                                        <?php endif; ?>
                                                    ...
                                                    <td>
                                                        <div class="box"><strong>Scheduled Install:</strong>  <?php echo (! empty($equipment->equipment_install_date) ? date("D, j M'y", strtotime($equipment->equipment_install_date)) :  'N/A'); ?> </div>
                                                        <?php if(empty($equipment->equipment_installed_date) && ( ! empty($equipment->equipment_delivered_date))): ?>
                                                             <button type="button" class="btn btn-info btn-xs btstrp_model" style="padding:3px 5px;font-size:10px;" onclick="showActionModal('<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($equipment->pt_id)); ?>', 2, '<?php echo e($equipment->equipment_install_date); ?>')">Approve</button>
                                                        <?php else: ?>
                                                        <div class="box"><strong>Installed:</strong> <?php echo (! empty($equipment->equipment_installed_date) ? date("D, j M'y", strtotime($equipment->equipment_installed_date)) :  'N/A'); ?> </div>
                                                        <?php endif; ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php echo (! empty($equipment->equipment_commision_date) ? date("D, j M'y", strtotime($equipment->equipment_commision_date)) :  'N/A'); ?>


                                                    </div>
                                                        <?php if(empty($equipment->equipment_commisioned_date) && ( ! empty($equipment->equipment_installed_date))): ?>
                                                             <button type="button" class="btn btn-info btn-xs btstrp_model" style="padding:3px 5px;font-size:10px;" onclick="showActionModal('<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($equipment->pt_id)); ?>', 3, '<?php echo e($equipment->equipment_commision_date); ?>')">Approve</button>
                                                        <?php else: ?>
                                                        <div class="box"><strong>Commissioned:</strong> <?php echo (! empty($equipment->equipment_commisioned_date) ? date("D, j M'y", strtotime($equipment->equipment_commisioned_date)) :  'N/A'); ?> </div>
                                                        <?php endif; ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if(empty($equipment->upload_pdf)): ?>
                                                                <button type="button" class="btn btn-info btn-xs btstrp_model" style="padding:3px 5px;font-size:10px;" onclick="showUploadModal('<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($equipment->pt_id)); ?>')">Upload</button>
                                                        <?php else: ?>
                                                                <a target="_blank" download href="<?php echo e(url('storage/uploads/' . $equipment->upload_pdf)); ?>"><i class="fa fa-pdf"></i> <?php echo e($equipment->upload_pdf); ?></a>
                                                        <?php endif; ?>
    ...
    <script>
            ...
            $("#project_timeline").validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                                    url: `<?php echo e(route('update-scheduled-equipment')); ?>`,
                                    type: "POST",    
                                    data: formData,
                                    processData: false,
                                    contentType: false,
            ...
            $("#project_timeline_actions").validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                                    url: `<?php echo e(route('update-scheduled-equipment-action')); ?>`,
                                    type: "POST",    
                                    data: formData,
                                    processData: false,
                                    contentType: false,
            ...
            $("#project_timeline_upload").validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                                    url: `<?php echo e(route('update-scheduled-equipment-upload')); ?>`,
                                    type: "POST",    
                                    data: formData,
                                    processData: false,
                                    contentType: false,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u457512262/domains/dssolution.in/public_html/dot/resources/views/pages/project_timeline/inst_create.blade.php ENDPATH**/ ?>